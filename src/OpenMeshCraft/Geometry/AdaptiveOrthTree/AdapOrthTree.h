...
protected: /* Modifiers ******************************************************/
	...
	virtual void calc_box_for_children(NodeRef nd, OrPointCRef center,
...
public: /* Queries */
	...
	OrBboxCRef box(index_t id) const { return m_boxes[id]; }
	OrBboxRef  box(index_t id) { return m_boxes[id]; }
