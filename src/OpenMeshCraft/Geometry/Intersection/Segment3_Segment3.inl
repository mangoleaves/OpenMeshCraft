  ...
  const GPointT &s11) const
{
	...
	bool s00_is_shared =
	  (LessThan3D().coincident(s00, s10) || LessThan3D().coincident(s00, s11));
	bool s01_is_shared =
	  (LessThan3D().coincident(s01, s10) || LessThan3D().coincident(s01, s11));
	bool s10_is_shared =
	  (LessThan3D().coincident(s10, s00) || LessThan3D().coincident(s10, s01));
	bool s11_is_shared =
	  (LessThan3D().coincident(s11, s00) || LessThan3D().coincident(s11, s01));
	...
	// segments are deemed overlapping if they are so in at least two projections
	// our of three (overlapping axis aligned segments will look like a valid
	// simplcial complex in one projection)
	if ((x_res == SimplexIntersectionType::OVERLAP &&
	     y_res == SimplexIntersectionType::OVERLAP &&
	     z_res != SimplexIntersectionType::INTERSECT) ||
	    (x_res == SimplexIntersectionType::OVERLAP &&
  ...
  const NT *s00, const NT *s01, const NT *s10, const NT *s11, int n1_max) const
{
	...
	if (n1_max == 0)
	{
		NT s00_dropX[2] = {s00[1], s00[2]}, s01_dropX[2] = {s01[1], s01[2]};
		NT s10_dropX[2] = {s10[1], s10[2]}, s11_dropX[2] = {s11[1], s11[2]};
		SimplexIntersectionType x_res =
		  Segment2_Segment2_DoInter().intersection_type(s00_dropX, s01_dropX,
		                                                s10_dropX, s11_dropX);
		if (x_res == SimplexIntersectionType::DO_NOT_INTERSECT)
			return SimplexIntersectionType::DO_NOT_INTERSECT;
		if (x_res == SimplexIntersectionType::OVERLAP)
	...
	else if (n1_max == 1)
	{
		NT s00_dropY[2] = {s00[0], s00[2]}, s01_dropY[2] = {s01[0], s01[2]};
		NT s10_dropY[2] = {s10[0], s10[2]}, s11_dropY[2] = {s11[0], s11[2]};
		SimplexIntersectionType y_res =
		  Segment2_Segment2_DoInter().intersection_type(s00_dropY, s01_dropY,
		                                                s10_dropY, s11_dropY);
		if (y_res == SimplexIntersectionType::DO_NOT_INTERSECT)
			return SimplexIntersectionType::DO_NOT_INTERSECT;
		if (y_res == SimplexIntersectionType::OVERLAP)
			return SimplexIntersectionType::OVERLAP;
	}
	else if (n1_max == 2)
	{
		NT s00_dropZ[2] = {s00[0], s00[1]}, s01_dropZ[2] = {s01[0], s01[1]};
		NT s10_dropZ[2] = {s10[0], s10[1]}, s11_dropZ[2] = {s11[0], s11[1]};
		SimplexIntersectionType z_res =
		  Segment2_Segment2_DoInter().intersection_type(s00_dropZ, s01_dropZ,
		                                                s10_dropZ, s11_dropZ);
		if (z_res == SimplexIntersectionType::DO_NOT_INTERSECT)
			return SimplexIntersectionType::DO_NOT_INTERSECT;
		if (z_res == SimplexIntersectionType::OVERLAP)
			return SimplexIntersectionType::OVERLAP;
	}
