FOR %%f in (.\direct\*.txt) DO ..\..\..\build\bin\Release\PredicatesGenerator.exe %%f -a -ft -it -et -ex
FOR %%f in (.\indirect\*.txt) DO ..\..\..\build\bin\Release\PredicatesGenerator.exe %%f -a -ft -it -et -ex
Rem FOR %%f in (.\lambda\*.txt) DO ..\..\..\build\bin\Release\PredicatesGenerator.exe %%f -a -ft -it -et -ex
